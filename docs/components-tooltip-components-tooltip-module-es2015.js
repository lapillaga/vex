...
let ComponentsTooltipRoutingModule = class ComponentsTooltipRoutingModule {
};
...
let ComponentsTooltipComponent = class ComponentsTooltipComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ComponentsTooltipModule = class ComponentsTooltipModule {
};
