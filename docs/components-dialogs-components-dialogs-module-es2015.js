...
let ComponentsDialogsRoutingModule = class ComponentsDialogsRoutingModule {
};
...
let ComponentsDialogsComponent = class ComponentsDialogsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ComponentsDialogsModule = class ComponentsDialogsModule {
};
