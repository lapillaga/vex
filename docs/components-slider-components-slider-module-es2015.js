...
let ComponentsSliderRoutingModule = class ComponentsSliderRoutingModule {
};
...
let ComponentsSliderComponent = class ComponentsSliderComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ComponentsSliderModule = class ComponentsSliderModule {
};
