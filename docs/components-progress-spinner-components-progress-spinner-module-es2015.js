...
let ComponentsProgressSpinnerRoutingModule = class ComponentsProgressSpinnerRoutingModule {
};
...
let ComponentsProgressSpinnerComponent = class ComponentsProgressSpinnerComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ComponentsProgressSpinnerModule = class ComponentsProgressSpinnerModule {
};
