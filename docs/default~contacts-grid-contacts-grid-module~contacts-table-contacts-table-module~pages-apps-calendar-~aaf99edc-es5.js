...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~contacts-grid-contacts-grid-module~contacts-table-contacts-table-module~pages-apps-calendar-~aaf99edc"], {
  /***/
        ...
        value: function _createPopup() {
          ...
          */
          function (event) {
            ...
            return event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_3__["ESCAPE"] || _this9._datepickerInput && event.altKey && event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_3__["UP_ARROW"];
          }))).subscribe(
          /**
          * @param {?} event
          * @return {?}
...
//# sourceMappingURL=default~contacts-grid-contacts-grid-module~contacts-table-contacts-table-module~pages-apps-calendar-~aaf99edc-es5.js.map