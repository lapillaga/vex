...
let ComponentsCardsRoutingModule = class ComponentsCardsRoutingModule {
};
...
let ComponentsCardsComponent = class ComponentsCardsComponent {
    constructor() {
...
let ComponentsCardsModule = class ComponentsCardsModule {
};
