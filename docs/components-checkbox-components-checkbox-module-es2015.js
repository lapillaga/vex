...
let ComponentsCheckboxRoutingModule = class ComponentsCheckboxRoutingModule {
};
...
let ComponentsCheckboxComponent = class ComponentsCheckboxComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ComponentsCheckboxModule = class ComponentsCheckboxModule {
};
